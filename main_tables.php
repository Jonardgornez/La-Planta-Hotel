    ...
    <div class="booking-card">
        ...
        <form action="tableData/submit_booking.php" method="POST" enctype="multipart/form-data">
            <div class="row g-4">
                ...
                <!-- ✅ Added Contact Number (Required in DB) -->
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="price" value="300" readonly style="background:none" class="form-control">
                </div>
                ...
                <!-- ✅ Fixed name to match database column -->
                <div class="col-md-6">
                    <label class="form-label">Payment Reference Number *</label>
                    <input type="text" name="gcashref_number" class="form-control" required>
                </div>
