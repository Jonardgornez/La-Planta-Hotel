...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        ...
        $stmt2 = $conn->prepare("SELECT FIRSTNAME, LASTNAME, EMAIL, BOOK_DATE, AUTO_NUMBER FROM tbl_appointment WHERE APP_ID=?");
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $referenceNumber = $row['AUTO_NUMBER']; // ✅ use AUTO_NUMBER as reference
        } else {
        ...
        $body = "Hello $clientName,<br><br>
                 Your appointment on <b>$bookDate</b> has been <b>approved</b>.<br>
        ...
        $_SESSION['error'] = $stmt->error; // better than $conn->error here
    }
