...
<div class="wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <h3 class="card-title"> 
                ...
                <button data-target="#GalleryDesc" data-toggle="modal" class="btn btn-primary btn-sm" <?=$YES_EDIT;?>> <span class="fa fa-pen"></span> GALLERY DESCRIPTION</button>
              </h3>
                    ...
                    while($row = $result->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <?php }else{ ?>
                            <a href="data:image/jpg;charset=utf8;base64,<?=base64_encode($row['GALLERY_IMAGE']); ?>" data-toggle="lightbox" data-title="<?=$row['GALLERY_DESC'];?>" data-gallery="gallery">
                            <img src="data:image/jpg;charset=utf8;base64,<?=base64_encode($row['GALLERY_IMAGE']); ?>" width="80" height="80" class="img-thumbnail  mb-2">
                          </a>
                          <?php }?>
                          </td>
                          <td><?=$row['GALLERY_DESC'];?></td>
                          <td><?=$row['GALLERY_SIZE'];?></td>
                          <td align="right">
							            <div class="btn-group">
                            <button class="btn btn-primary btn-sm"
                            data-reqid="<?=$row['GALLERY_ID'];?>" 
                            data-reqname="<?=$row['GALLERY_DESC'];?>"
 ...
 function editLGU(self) {
      ...
      document.getElementsByClassName("edit_reqid")[0].value = reqid;
      document.getElementsByClassName("edit_reqname")[0].value = reqname;
