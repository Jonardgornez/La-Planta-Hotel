...
<div class="modal fade" id="_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal needs-validation" action="attractions_add.php" method="POST"  autocomplete="off" enctype="multipart/form-data" novalidate>
...
<div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal submit-livelihood-validation" action="attractions_edit.php" method="POST"  autocomplete="off" enctype="multipart/form-data" novalidate>
            <div class="modal-body">
                <input type="hidden" class="edit_attractid" name="ATTRACT_ID" required>
          		  <div class="row">
                    <div class="col-sm-12">
                    <label for="lastname" class="control-label font-weight-normal">DESCRIPTION</label>
                       <div class="input-group">
                     
                            <input type="text" class="form-control edit_attractdesc" name="ATTRACT_DESC" required>     
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label for="lastname" class="control-label font-weight-normal">IMAGE</label>
...
<div class="modal fade" id="del_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="attractions_delete.php" method="POST">
            <div class="modal-body text-center">
                 <input type="hidden" class="del_attractid" name="ATTRACT_ID">
...
<div class="modal fade" id="GalleryDesc" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal submit-livelihood-validation" action="attractions_edit_desc.php" method="POST"  autocomplete="off" enctype="multipart/form-data" novalidate>
            <div class="modal-body">
          		  <div class="row">
                    <div class="col-sm-12">
                    <label for="lastname" class="control-label font-weight-normal">DESCRIPTION</label>
                    <?php
                    $sql = "SELECT * FROM tbl_attractions LIMIT 1";
                    $sql=$conn->prepare($sql);
                    if($sql->execute()){
                        $aresult=$sql->get_result();
                        if($aresult->num_rows >0){
                            $row_about = $aresult->fetch_assoc();
                            $atbout= $row_about["ATTRACT_ABOUT"];
                            print '<textarea rows="10" class="form-control"  name="ATTRACT_ABOUT" required>'.$atbout.'</textarea>';
                        }else{
                            print '<textarea rows="10" class="form-control"  name="ATTRACT_ABOUT" required>Empty</textarea>';
                        }
                    }
                      ?>
