                    ...
                    while($row = $result->fetch_assoc()){
                      ?>
                        ...
                        ?>
                          ...
                          <td align="right">
                          <div class="btn-group">
                            <button data-cid="<?=$row['review_id'];?>" data-email="<?=$row['user_email'];?>" data-name="<?=$row['user_name'];?>" onclick="delCotactn(this);"  class="btn bg-maroon btn-sm delete" <?php print $YES_DELETE;?>><i class="fa-solid fa fa-trash"></i> </button>
                           </div>
                          </td>
                        </tr>
                      <?php
