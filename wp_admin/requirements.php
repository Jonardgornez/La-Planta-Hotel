          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                      <h3 class="card-title"> 
              <button href="#_add_modal" data-toggle="modal" class="btn btn-primary btn-sm" <?php print $YES_ADD;?>><i class="fa fa-plus"></i> REQUIREMENTS</button>
              </h3>
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="right">
                            ...
                            onclick="editLGU(this);" data-jario="tooltip" data-placement="top" title="EDIT" <?php print $YES_EDIT;?>><i class="fa-solid fa fa-edit"></i> </button>
                            <button class="btn btn-danger btn-sm" 
                            data-reqid="<?=$row['REQ_ID'];?>" 
                            onclick="deleteLGU(this);" data-jario="tooltip" data-placement="top" title="DELETE" <?php print $YES_DELETE;?>><i class="fa-solid fa fa-trash"></i> </button>
							            </div>
                          </td>
                        </tr>
                      <?php
